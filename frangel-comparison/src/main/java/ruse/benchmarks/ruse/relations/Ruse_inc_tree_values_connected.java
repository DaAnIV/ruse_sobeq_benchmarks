...
public enum Ruse_inc_tree_values_connected implements TaskCreator {
    INSTANCE;
    static {
    ...
    public SynthesisTask createTask() {
        SynthesisTask task = new SynthesisTask()
                .setName("ruse_inc_tree_values_connected")
        ...
        task.addExample(new Example()
                .setInputs(() -> {
                    BinaryTree tree3 = new BinaryTree(7, new BinaryTree(5), new BinaryTree(6));
                    return new Object[] { 
                        tree3.getLeft(),
                        tree3.getRight(),
                        tree3
